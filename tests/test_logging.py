...
from statdash_cli.logging import SYSLOG_FACILITIES, log_submit_error, log_to_syslog
...
class TestLogToSyslog:
    ...
    @mock.patch("statdash_cli.logging.syslog")
...
class TestLogSubmitError:
    ...
    @mock.patch("statdash_cli.logging.log_to_syslog")
