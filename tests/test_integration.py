"""Integration tests for StatShed CLI against the real backend.
...
from statshed_cli.errors import ExitCode  # noqa: E402
from statshed_cli.main import cli  # noqa: E402
...
def integration_server() -> Generator[tuple[str, Any], None, None]:
    ...
    test_db_path = BACKEND_PATH / "test_statshed.db"
